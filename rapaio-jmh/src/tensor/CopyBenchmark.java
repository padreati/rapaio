...
public class CopyBenchmark {
    ...
    @Benchmark
    public void transposeJSAT(BenchmarkState bs, Blackhole bh) {
        bh.consume(bs.jsatA.transpose());
    }

    @Benchmark
    public void transposeBaseOrderC(BenchmarkState bs, Blackhole bh) {
        var transpose = bs.bTc.t();
        bh.consume(transpose);
    }

    @Benchmark
    public void transposeBaseOrderF(BenchmarkState bs, Blackhole bh) {
        var transpose = bs.bTf.t();
        bh.consume(transpose);
    }
