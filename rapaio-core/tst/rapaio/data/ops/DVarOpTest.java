...
public class DVarOpTest {
    ...
    void varDoubleSortedTest() {
        ...
        VarDouble apply1 = x.copy().tensor_().apply_(v -> v + 1).dv();
        VarDouble apply2 = x.tensor().apply_(v -> v + 1).dv();
        VarDouble apply3 = x.tensor().add_(1.).dv();
        VarDouble apply4 = x.tensor().add_(VarDouble.fill(100, 1).tensor_()).dv();

        assertTrue(apply1.deepEquals(apply2));
        assertTrue(apply1.deepEquals(apply3));
        assertTrue(apply1.deepEquals(apply4));

        double sum1 = x.tensor_().nanSum();
    ...
    void varIntSortedTest() {
        ...
        Var apply1 = x.copy();
        apply1.tensor_().apply_(v -> v + 1);
        Var apply3 = x.copy();
        apply3.tensor_().add_(1.0);
        Var apply4 = x.copy();
        apply4.tensor_().add_(VarDouble.fill(100, 1).tensor_());

        assertTrue(apply1.deepEquals(apply3));
        assertTrue(apply1.deepEquals(apply4));

        double sum1 = x.tensor_().nanSum();
        assertEquals(sum1, x.tensor().sort_(0, true).nanSum());
