...
public record NominalInSet(String testName, Set<String> testValues) implements RowPredicate {
    ...
    public String toString() {
        return testName + " in [" + testValues.stream().map(s -> '\'' + s + '\'').collect(Collectors.joining(",")) + ']';
    }
}
