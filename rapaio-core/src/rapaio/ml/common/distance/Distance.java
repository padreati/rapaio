...
public interface Distance extends ParametricEquals<Distance> {
    ...
    /**
     * Compute distance between two double vectors {@link DArray <Double>}.
     *
     * @param x first parameter
     * @param y second parameter
     * @return computed distance
     */
    double compute(DArray<Double> x, DArray<Double> y);
    ...
    /**
     * Compute reduced distance between two double vectors {@link DArray <Double>}.
     ...
     */
    double reduced(DArray<Double> x, DArray<Double> y);
