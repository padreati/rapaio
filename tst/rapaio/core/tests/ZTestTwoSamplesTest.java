...
public class ZTestTwoSamplesTest {
    ...
    public void zTestTwoSamples() {
        ...
        assertEquals(0.2929833949856928, z1.getPValue(), TOL);
        assertEquals(1.3003232007875778, z1.getCILow(), TOL);
        assertEquals(2.211040435576059, z1.getCIHigh(), TOL);
        ...
        assertEquals(1.5169976386175676E-11, z2.getPValue(), TOL);
        assertEquals(1.3276174779349252, z2.getCILow(), TOL);
        assertEquals(2.1837461584287112, z2.getCIHigh(), TOL);

        ZTestTwoSamples z3 = ZTestTwoSamples.test(x, NumericVar.empty(), 0, 0.5, 0.5);
        z3.printSummary();

        assertEquals(Double.NaN, z3.getZScore(), TOL);
        assertEquals(Double.NaN, z3.getPValue(), TOL);
        assertEquals(Double.NaN, z3.getCILow(), TOL);
        assertEquals(Double.NaN, z3.getCIHigh(), TOL);
        ...
        assertEquals(0.8535083025071536, z4.getPValue(), TOL);
        assertEquals(1.3003232007875778, z4.getCILow(), TOL);
        assertEquals(2.211040435576059, z4.getCIHigh(), TOL);
        ...
        assertEquals(0.1464916974928464, z5.getPValue(), TOL);
        assertEquals(1.3003232007875778, z5.getCILow(), TOL);
        assertEquals(2.211040435576059, z5.getCIHigh(), TOL);
    }
