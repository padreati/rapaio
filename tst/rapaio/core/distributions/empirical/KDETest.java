...
public class KDETest {
    ...
    private Var x = SolidVarDouble.seq(-20, 20, 0.01);
    private Var y;
    ...
    public void setUp() throws Exception {
        ...
        y = SolidVarDouble.from(x, normal::pdf);
    }
    ...
    public void test(KFunc fun) {
        ...
        Var z = SolidVarDouble.from(x, kde::pdf);
        Var delta = SolidVarDouble.from(x.rowCount(), row -> y.getDouble(row)-z.getDouble(row));
