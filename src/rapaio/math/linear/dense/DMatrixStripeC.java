...
public class DMatrixStripeC extends DMatrixStripe {
    ...
    @Override
    public rapaio.math.linear.dense.DMatrixStripeC copy() {
        rapaio.math.linear.dense.DMatrixStripeC copy = new rapaio.math.linear.dense.DMatrixStripeC(rowCount, colCount);
        for (int i = 0; i < colCount; i++) {
