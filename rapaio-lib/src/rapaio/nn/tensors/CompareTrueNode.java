...
public final class CompareTrueNode extends Tensor {

    private final DArray<?> mask;

    public CompareTrueNode(Tensor x, Compare cmp, double threshold) {
        super(x.tm(), CompareTrueNode.class.getSimpleName());
