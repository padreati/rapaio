...
package rapaio.ml.supervised.svm;
 ...
 */
public class BinarySMO extends ClassifierModel<BinarySMO, ClassifierResult, ClassifierHookInfo> {
    ...
    protected boolean coreFit(Frame initDf, Var initWeights) {
        ...
        while (runs-- >= 0 && (numChanged > 0 || examineAll)) {
            ...
            if (runningHook.get() != null) {
                runningHook.get().accept(new ClassifierHookInfo(this, maxRuns.get() - runs - 1));
            }
        }
