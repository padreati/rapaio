...
public class FillMissingTest {
    ...
    @Test
    void testDouble() {
        var copy = df.copy().fapply(FillMissing.onDouble(10, VarRange.of("a")));
    ...
    @Test
    void testInt() {
        var copy = df.copy().fapply(FillMissing.onInt(10, VarRange.of("b")));
        assertFalse(copy.deepEquals(df));
    ...
    @Test
    void testString() {
        var copy = df.copy().fapply(FillMissing.onLabel("x", VarRange.of("c")).newInstance());
        assertFalse(copy.deepEquals(df));
