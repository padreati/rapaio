...
public class PrimesConjecturesHtml1 {
	...
	private void run() {
		...
		p("It is a known fact that \\(\\pi(x,a,b) \\sim \\frac{1}{\\varphi(q)}\\frac{x}{ln(x)}\\). "
				+ "That means that this number does not depend on the getValue of \\(a\\). "
		...
		p("It is obvious that the getValue of delta function is always greater or equal than 0 with one exception. "
				+ "This exception was determined also by Chebyshev, and the getValue is 2946. "
		...
		p("It is sure that we can't draw any conclusion from those plots. The delta function looks "
				...
				+ "assume that most of the time the delta function has a positive getValue. For me, at least, "
