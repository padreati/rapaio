...
public class ZTestTwoPairedTest {
    ...
    public void zTestTwoPairedTest() {
        ...
        Var x = SolidVarDouble.copy(7.8, 6.6, 6.5, 7.4, 7.3, 7.0, 6.4, 7.1, 6.7, 7.6, 6.8);
        Var y = SolidVarDouble.copy(4.5, 5.4, 6.1, 6.1, 5.4, 5., 4.1, 5.5);
        ...
        ZTestTwoPaired z2 = ZTestTwoPaired.test(x, SolidVarDouble.copy(Double.NaN, Double.NaN), 2, 0.5, 0.05, HTest.Alternative.LESS_THAN);
        z2.printSummary();
