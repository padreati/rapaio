 ...
 */
@Deprecated
public class FFAbstractOneHotEncoding extends FFAbstract {

    public FFAbstractOneHotEncoding(String... varNames) {
        super(varNames);
    }
    ...
    public Frame apply(Frame df) {
        ...
        for (String varName : df.varNames()) {
            if (nameSet.contains(varName) && df.getVar(varName).type().isNominal()) {
