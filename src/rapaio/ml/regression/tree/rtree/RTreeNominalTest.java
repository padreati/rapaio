...
public interface RTreeNominalTest extends Serializable {
     ...
     */
    static RTreeNominalTest ignore() {
        return new NominalIgnore();
    }
     ...
     */
    static RTreeNominalTest full() {
        return new NominalFull();
    }
     ...
     */
    static RTreeNominalTest binary() {
        return new NominalBinary();
    }
}

class NominalIgnore implements RTreeNominalTest {
...
class NominalFull implements RTreeNominalTest {
...
class NominalBinary implements RTreeNominalTest {
