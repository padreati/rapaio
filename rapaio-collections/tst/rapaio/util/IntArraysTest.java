...
public class IntArraysTest {
    ...
    @Test
    void buildersTest() {
        Assertions.assertArrayEquals(new int[] {10, 10, 10}, IntArrays.newFill(3, 10));
        Assertions.assertArrayEquals(new int[] {10, 11, 12}, IntArrays.newSeq(10, 13));
        Assertions.assertArrayEquals(new int[] {4, 9, 16}, IntArrays.newFrom(new int[] {1, 2, 3, 4, 5}, 1, 4, x -> x * x));
        Assertions.assertArrayEquals(new int[] {3, 5}, IntArrays.newCopy(new int[] {1, 3, 5, 7}, 1, 2));
    }
    ...
    void testIterator() {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            Assertions.assertEquals(array[i], it1.nextInt());
        }
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Assertions.assertEquals(array[i], it2.nextInt());
        }
    ...
    @Test
    void testCapacity() {
        var array1 = IntArrays.newSeq(0, 100);

        // new copy preserving 10
        var array2 = IntArrays.forceCapacity(array1, 10, 10);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array2, 0, 10));
        Assertions.assertEquals(10, array2.length);

        // new copy preserving 80
        var array3 = IntArrays.forceCapacity(array1, 120, 80);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array3, 0, 80));
        Assertions.assertEquals(120, array3.length);

        // leave array untouched
        var array4 = IntArrays.ensureCapacity(array1, 10);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array4, 0, 100));
        Assertions.assertEquals(100, array4.length);

        // new copy preserving all available
        var array5 = IntArrays.ensureCapacity(array1, 120);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array5, 0, 100));
        Assertions.assertEquals(120, array5.length);

        // new copy preserving 10
        var array6 = IntArrays.ensureCapacity(array1, 120, 10);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array6, 0, 10));
        Assertions.assertTrue(IntArrays.equals(IntArrays.newFill(90, 0), 0, array6, 10, 90));

        // leave untouched
        var array7 = IntArrays.grow(array1, 10);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array7, 0, 100));
        Assertions.assertEquals(100, array7.length);

        // new copy preserving all
        var array8 = IntArrays.grow(array1, 120);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array8, 0, 100));
        Assertions.assertEquals(150, array8.length);

        // new copy preserving 10
        var array9 = IntArrays.grow(array1, 200, 10);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array9, 0, 10));
        Assertions.assertTrue(IntArrays.equals(IntArrays.newFill(190, 0), 0, array9, 10, 190));
        Assertions.assertEquals(200, array9.length);

        // trim array to 10
        var array10 = IntArrays.trim(array1, 10);
        Assertions.assertEquals(10, array10.length);
        Assertions.assertTrue(IntArrays.equals(array1, 0, array10, 0, 10));
    }
