...
public class DVectorTest {
    ...
    public void testBuilders() {
        ...
        assertTrue(DVector.fromCount(true, NomVar.copy("a", "b", "a")).equalsFull(DVector.fromCount(true, NomVar.copy("a", "a", "b"))));
        assertTrue(DVector.empty(false, 2).equalsFull(DVector.empty(true, "v1")));
        assertTrue(DVector.fromCount(true, NomVar.copy("a", "a", "b", "c"))
