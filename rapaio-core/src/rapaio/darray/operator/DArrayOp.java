...
import rapaio.darray.operator.impl.UnaryOpAbs;
import rapaio.darray.operator.impl.UnaryOpAcos;
import rapaio.darray.operator.impl.UnaryOpAsin;
import rapaio.darray.operator.impl.UnaryOpAtan;
import rapaio.darray.operator.impl.UnaryOpCeil;
import rapaio.darray.operator.impl.UnaryOpClamp;
import rapaio.darray.operator.impl.UnaryOpCompareMask;
import rapaio.darray.operator.impl.UnaryOpCos;
import rapaio.darray.operator.impl.UnaryOpCosh;
import rapaio.darray.operator.impl.UnaryOpExp;
import rapaio.darray.operator.impl.UnaryOpExpm1;
import rapaio.darray.operator.impl.UnaryOpFill;
import rapaio.darray.operator.impl.UnaryOpFillNan;
import rapaio.darray.operator.impl.UnaryOpFloor;
import rapaio.darray.operator.impl.UnaryOpLog;
import rapaio.darray.operator.impl.UnaryOpLog1p;
import rapaio.darray.operator.impl.UnaryOpLogSoftmax;
import rapaio.darray.operator.impl.UnaryOpNanToNum;
import rapaio.darray.operator.impl.UnaryOpNeg;
import rapaio.darray.operator.impl.UnaryOpPow;
import rapaio.darray.operator.impl.UnaryOpRint;
import rapaio.darray.operator.impl.UnaryOpSigmoid;
import rapaio.darray.operator.impl.UnaryOpSin;
import rapaio.darray.operator.impl.UnaryOpSinh;
import rapaio.darray.operator.impl.UnaryOpSoftmax;
import rapaio.darray.operator.impl.UnaryOpSqr;
import rapaio.darray.operator.impl.UnaryOpSqrt;
import rapaio.darray.operator.impl.UnaryOpTan;
import rapaio.darray.operator.impl.UnaryOpTanh;
