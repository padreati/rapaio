...
![test text](../images/graphics-boxplot-iris-frame.png)

![Box plots for the same variable, but discriminated by class](../images/graphics-boxplot-iris-sepal-length.png)
