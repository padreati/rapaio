...
public final class NominalFilters {
	...
	/**
	 * Split a frame into multiple frames, one for each getLabel in
	 * the term getDictionary of the nominal getValue given as parameter.
	 *
	 * @param df           source frame
	 * @param nominalIndex getIndex fo the nominal column
	 * @return an array of frames, one for each nominal getLabel
	 */
