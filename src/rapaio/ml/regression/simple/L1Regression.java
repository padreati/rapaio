...
public class L1Regression extends AbstractRegression implements Printable {
    ...
    public L1Regression newInstance() {
        return newInstanceDecoration(new L1Regression());
    }
    ...
    @Override
    public L1Regression fit(Frame df, String... targetVars) {
        return (L1Regression) super.fit(df, targetVars);
    }

    @Override
    public L1Regression fit(Frame df, Var weights, String... targetVarNames) {
        return (L1Regression) super.fit(df, weights, targetVarNames);
    }
