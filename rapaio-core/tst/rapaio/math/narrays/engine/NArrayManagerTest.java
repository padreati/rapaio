...
package rapaio.math.narrays.engine;
...
import rapaio.math.narrays.manager.base.BaseNArrayManager;
...
public class NArrayManagerTest {
    ...
    void testManagerSuite(NArrayManager engine) {
    ...
    <N extends Number> void testManager(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testZeros(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testEye(NArrayManager engine, NArrayManager.OfType<N> ofType) {
        var t = ofType.eye(3);
    ...
    <N extends Number> void testFull(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testSeq(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testRandom(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testStride(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testWrap(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testConcatenate(NArrayManager engine, NArrayManager.OfType<N> ofType) {
    ...
    <N extends Number> void testStack(NArrayManager engine, NArrayManager.OfType<N> ofType) {
        var t1 = ofType.stride(Shape.of(2, 3), Order.C, ofType.storage().from(1., 2, 3, 4, 5, 6));
    ...
    <N extends Number> void testTake(NArrayManager engine, NArrayManager.OfType<N> ofType) {
        NArray<N> t = ofType.seq(Shape.of(100));
        ...
        NArray<N> m = ofType.seq(Shape.of(4, 4));
    ...
    <N extends Number> void testExpand(NArrayManager engine, NArrayManager.OfType<N> ofType) {
        NArray<N> t1 = ofType.seq(Shape.of(4, 1, 2));
        ...
        NArray<N> t2 = ofType.seq(Shape.of(4, 2, 1));
        ...
        NArray<N> t3 = ofType.seq(Shape.of(1, 2, 4));
