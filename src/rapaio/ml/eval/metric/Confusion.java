...
public final class Confusion implements Printable {
    ...
    private final RM cmFrequency;
    private final RM cmProbability;
    ...
    private void compute() {
        ...
        cmProbability.plus(cmFrequency).dot(1.0 / completeCases);
