...
public class ParallelArrayTensorEngine extends AbstractTensorEngine {

    private static final class ImplOfDouble implements OfDouble {

        private final ParallelArrayTensorEngine self;

        ImplOfDouble(ParallelArrayTensorEngine self) {
            this.self = self;
        }
    ...
    private static final class ImplOfFloat implements OfFloat {
        ...
        ImplOfFloat(ParallelArrayTensorEngine self) {
            this.self = self;
        }
    ...
    private final OfDouble _ofDouble = new ParallelArrayTensorEngine.ImplOfDouble(this);
    private final OfFloat _ofFloat = new ParallelArrayTensorEngine.ImplOfFloat(this);
