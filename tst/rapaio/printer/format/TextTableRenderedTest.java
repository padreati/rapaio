...
public class TextTableRenderedTest {
    ...
    public void testSimple() throws IOException {
        ...
        TextTableRenderer tt = TextTableRenderer.empty(iris.rowCount() + 1, iris.varCount() + 1);
    ...
    public void testDotCentering() {
        TextTableRenderer tt = TextTableRenderer.empty(5, 1);
    ...
    public void testDynamic() {
        ...
        assertEquals("header col   x1          x2          x1        header col   x1          x2          x1        header col   x1          x2          x1        \n" +
                "  999999   -10.3975897   3.7379485 -12.935949    989897    -3.0649885 -16.0310845   5.8062882   979898     6.2702582  -7.5640252 -19.1781901 \n" +
                "  989997    11.4228522 -29.2332262  16.5667972   979798   -24.3172998  20.6345505 -20.1644745   989997    36.3624695  11.9810382  -8.5143005 \n" +
