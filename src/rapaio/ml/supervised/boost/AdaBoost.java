 ...
 */
public class AdaBoost extends ClassifierModel<AdaBoost, ClassifierResult, ClassifierHookInfo> implements Printable {
    ...
    protected boolean coreFit(Frame df, Var weights) {
        ...
        Var w = weights.asDVector(With.copy()).div(weights.asDVector().nansum()).asVarDouble();
        ...
        for (int i = 0; i < runs.get(); i++) {
            ...
            if (runningHook.get() != null) {
                runningHook.get().accept(new ClassifierHookInfo(this, i));
            }
        }
        return true;
    }
    ...
    private boolean learnRound(Frame df, Var w, double k) {
        ...
        w.asDVector().div(w.asDVector().nansum());
