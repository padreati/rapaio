...
public class BaseMath {
    ...
    /**
     * Returns the number e^x, where e is the base of natural logarithms.
     *
     * @param x the power of e
     * @return e^x
     */
    public static double exp(double x) {
        return Math.pow(BaseMath.E, x);
    }
     ...
     * @param pow the second argument, the power
     * @return x power of pow
     */
     ...
     *
     * @param x number from which we took the square root
    ...
    public static double erf(double x) {
        return 2 * new Normal(0, 1).cdf(x * sqrt(2.0)) - 1;
    }
    ...
    public static double inverf(double x) {
        return new Normal(0, 1).quantile(x / 2 + 0.5) / sqrt(2.0);
    }
    ...
    public static double erfc(double x) {
        return 2 * new Normal(0, 1).cdf(-x * sqrt(2.0));
    }
    ...
    public static double inverfc(double x) {
        return new Normal(0, 1).quantile(x / 2) / -sqrt(2.0);
    }
    ...
    private static double lentz(double... args) {
        ...
        int j = 0;
        while (BaseMath.abs(delta - 1) > 1e-15) {
