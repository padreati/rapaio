                ...
                switch (k) {
                    ...
                    case 1111:
                        ...
                        if (fill) {
                            ...
                            path.moveTo(xScale(x.getDouble(i)), yScale(y.getDouble(j)));
                            path.lineTo(xScale(x.getDouble(i + 1)), yScale(y.getDouble(j)));
                            path.lineTo(xScale(x.getDouble(i + 1)), yScale(y.getDouble(j + 1)));
