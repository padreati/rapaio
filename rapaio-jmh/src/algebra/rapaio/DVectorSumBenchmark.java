...
public class DVectorSumBenchmark {
    ...
    public static void runTest() throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(DVectorSumBenchmark.class.getSimpleName())
                ...
                .result(Utils.resultPath(DVectorSumBenchmark.class))
                .build();
    ...
    public static void printResults() {
        Frame df = Csv.instance().quotes.set(true).read(Utils.resultPath(DVectorSumBenchmark.class));
