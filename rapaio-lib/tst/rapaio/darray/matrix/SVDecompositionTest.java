...
public class SVDecompositionTest {
    ...
    <N extends Number> void testBuilder(DArrayManager tm, DType<N> dt) {
        ...
        for (int round = 0; round < ROUNDS; round++) {
            ...
            DArray<N> a = tm.random(dt, Shape.of(m, n), random);
            ...
            DArray<N> sv = svd.singularValues();
            for (int i = 0; i < n - 1; i++) {
    ...
    <N extends Number> void testProjectors(DArrayManager tm, DType<N> dt) {
        for (int i = 0; i < ROUNDS; i++) {
