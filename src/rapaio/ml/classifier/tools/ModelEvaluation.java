...
//                if (test.var(classColName).index(j) == c.classes().index(j)) {
//                    fcorrect++;
//                }
//            }
...
//                c.predict(test);
//                double acc = 0;
//                for (int j = 0; j < c.classes().rowCount(); j++) {
//                    if (c.classes().index(j) == test.var(classColName).index(j)) {
//                        acc++;
//                    }
//                }
//                acc /= (1. * c.classes().rowCount());
//                tacc[k] += acc;
