...
public class VFToTest {
    ...
    public void testToNumeric() {
        Var num1 = Numeric.newWrap(1.0, 2.0, 1.2, Double.NaN, 3.0, Double.NaN, 3.2);
        Var nom1 = Nominal.newCopy("1", "2", "1.2", "?", "3", "?", "3.2");
        Var nom2 = Nominal.newCopy("1", "2", "1.2", "mimi", "3", "lulu", "3.2");
        ...
        Assert.assertTrue(Numeric.newWrap(1, 2, 1.2, Double.NaN, 3, Double.NaN, 3.2)
        ...
        Assert.assertTrue(Numeric.newWrap(1, 2, 3, Double.NaN, 3, Double.NaN, 4)
                .deepEquals(idx1.fitApply(VFToNumeric.byDefault())));

        Assert.assertTrue(Numeric.newWrap(1, 0, 1, Double.NaN, 1, Double.NaN, 0)
                .deepEquals(bin1.fitApply(VFToNumeric.byDefault())));

        // by spot transformer

        Assert.assertTrue(Numeric.newWrap(1, 1, 1, 0, 1, 0, 1)
    ...
    public void testToIndex() {
        Var num1 = Numeric.newWrap(1.0, 2.0, 1.2, Double.NaN, 3.0, Double.NaN, 3.2);
        Var nom1 = Nominal.newCopy("1", "2", "1.2", "?", "3", "?", "4");
        Var nom2 = Nominal.newCopy("1", "2", "1.2", "mimi", "3", "lulu", "3.2");
        Var idx1 = Index.copy(1, 2, 3, Integer.MIN_VALUE, 3, Integer.MIN_VALUE, 4);
        Var bin1 = Binary.copy(1, 0, 1, -1, 1, -1, 0);
