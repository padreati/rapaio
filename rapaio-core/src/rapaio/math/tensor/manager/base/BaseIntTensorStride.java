...
public final class BaseIntTensorStride extends AbstractStrideTensor<Integer> {
    ...
    @Override
    public Tensor<Integer> binaryOp_(TensorBinaryOp op, Tensor<?> b) {
        if (b.isScalar()) {
    ...
    @Override
    public Integer vdot(Tensor<?> tensor) {
        return vdot(tensor, 0, shape().dim(0));
    }

    @Override
    public Integer vdot(Tensor<?> tensor, int start, int end) {
    ...
    @Override
    public Tensor<Integer> mv(Tensor<?> tensor) {
    ...
    @Override
    public Tensor<Integer> mm(Tensor<?> t, Order askOrder) {
        ...
        List<Tensor<Integer>> cols = t.cast(dtype()).chunk(1, false, 1);
