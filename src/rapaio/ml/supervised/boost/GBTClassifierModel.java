 ...
 */
public class GBTClassifierModel extends ClassifierModel<GBTClassifierModel, ClassifierResult, ClassifierHookInfo> {
    ...
    public boolean coreFit(Frame df, Var weights) {
        ...
        for (int m = 0; m < runs.get(); m++) {
            ...
            if (runningHook.get() != null) {
                runningHook.get().accept(new ClassifierHookInfo(this, m));
            }
        }
        return true;
    }
