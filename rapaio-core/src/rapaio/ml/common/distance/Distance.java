...
public interface Distance extends ParametricEquals<Distance> {
    ...
    /**
     * Compute distance between two double vectors {@link NArray <Double>}.
     *
     * @param x first parameter
     * @param y second parameter
     * @return computed distance
     */
    double compute(NArray<Double> x, NArray<Double> y);
    ...
    /**
     * Compute reduced distance between two double vectors {@link NArray <Double>}.
     ...
     */
    double reduced(NArray<Double> x, NArray<Double> y);
