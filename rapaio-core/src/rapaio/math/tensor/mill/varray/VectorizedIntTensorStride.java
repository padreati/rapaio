...
import rapaio.math.tensor.mill.barray.BaseIntTensorStride;
...
public final class VectorizedIntTensorStride extends BaseIntTensorStride implements IntTensor {
    ...
    public VectorizedIntTensorStride(VectorizedArrayTensorMill mill, Shape shape, int offset, int[] strides, int[] array) {
        this(mill, StrideLayout.of(shape, offset, strides), array);
    }

    public VectorizedIntTensorStride(VectorizedArrayTensorMill mill, Shape shape, int offset, Order order, int[] array) {
        this(mill, StrideLayout.ofDense(shape, offset, order), array);
    }

    public VectorizedIntTensorStride(VectorizedArrayTensorMill mill, StrideLayout layout, int[] array) {
    ...
    @Override
    public VectorizedIntTensorStride apply_(Order askOrder, IntIntBiFunction<Integer> apply) {
