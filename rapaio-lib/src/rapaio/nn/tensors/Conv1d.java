 ...
 * </ul>
 */
public final class Conv1d extends Tensor {

    public Conv1d(Tensor x, Tensor w, Tensor b, int padding, int stride, int dilation, int groups) {
        super(x.tm(), Conv1d.class.getSimpleName());
