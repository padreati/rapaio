...
public class DropoutNode extends Tensor {

    public DropoutNode(Tensor child, double p, Random random, boolean inplace) {
        super(child.tm(), DropoutNode.class.getSimpleName());
