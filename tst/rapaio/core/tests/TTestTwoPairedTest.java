...
public class TTestTwoPairedTest {
    ...
    public void basicTest() {
        ...
        VarDouble x = SolidVarDouble.copy(18, 21, 16, 22, 19, 24, 17, 21, 23, 18, 14, 16, 16, 19, 18, 20, 12, 22, 15, 17);
        VarDouble y = SolidVarDouble.copy(22, 25, 17, 24, 16, 29, 20, 23, 19, 20, 15, 15, 18, 26, 18, 24, 18, 25, 19, 16);
        ...
        TTestTwoPaired t2 = TTestTwoPaired.test(SolidVarDouble.empty(), SolidVarDouble.empty(), -1, 0.03, HTest.Alternative.GREATER_THAN);
