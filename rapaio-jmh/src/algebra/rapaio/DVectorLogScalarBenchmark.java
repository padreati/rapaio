...
public class DVectorLogScalarBenchmark {
    ...
    public static void runTest() throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(DVectorLogScalarBenchmark.class.getSimpleName())
                ...
                .result(Utils.resultPath(DVectorLogScalarBenchmark.class))
                .build();
    ...
    public static void printResults() {
        Frame df = Csv.instance().quotes.set(true).read(Utils.resultPath(DVectorLogScalarBenchmark.class));
