...
public final class Std1dNode extends Tensor {

    public Std1dNode(Tensor x, int axis, int ddof, double epsilon, Tensor mean) {
        super(x.tm(), Std1dNode.class.getSimpleName());
