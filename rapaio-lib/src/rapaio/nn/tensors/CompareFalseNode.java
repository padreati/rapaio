...
public final class CompareFalseNode extends Tensor {

    private final DArray<?> mask;

    public CompareFalseNode(Tensor x, Compare cmp, double threshold) {
        super(x.tm(), CompareFalseNode.class.getSimpleName());
