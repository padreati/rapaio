...
//        classes = Nominal.newEmpty(test.rowCount(), dict);
//        for (int i = 0; i < test.rowCount(); i++) {
//            classes.setLabel(i, predict(test, i));
//        }
//    }
//
...
//            dvs[df.index(i, testCol)].update(df.index(i, targetVars), weights.value(i));
//        }
//        for (int i = 0; i < len; i++) {
...
//                RowComparators.nominalComparator(df.var(targetVars), true));
//        int pos = 0;
...
//            for (int i = 0; i < pos; i++) {
//                hist[df.index(sort.index(i), targetVars)] += weights.value(sort.index(i));
//            }
...
//                index = df.index(sort.index(i), targetVars);
...
//            while (i < sort.rowCount()) {
//                index = sort.index(i);
//                if (df.index(sort.index(i), targetVars) == index) {
//                    hist[index] += weights.value(sort.index(i));
//                    i++;
//                    continue;
//                }
