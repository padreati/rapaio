...
public class DVectorFillBenchmark {
    ...
    @Benchmark
    public void testDenseDirect(VectorState s, Blackhole nh) {
        double[] array = s.vd.array();
        int offset = s.vd.offset();
        int size = s.vd.size();
...
//    }
    ...
    public static void runTest() throws RunnerException {
        Options opt = new OptionsBuilder()
                .include(DVectorFillBenchmark.class.getSimpleName())
                ...
                .result(Utils.resultPath(DVectorFillBenchmark.class))
                .build();
    ...
    public static void printResults() {
        Frame df = Csv.instance().quotes.set(true).read(Utils.resultPath(DVectorFillBenchmark.class));
