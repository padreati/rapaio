...
///
/// * *Data type* - defined by [DType][rapaio.math.narray.DType], describes data types used by arrays and offers low level operations
/// for working with values like casting, floating point flag, not a number check.
/// * *Storage* - presented by [Storage][rapaio.math.narray.Storage] and [StorageManager][rapaio.math.narray.StorageManager] interfaces;
...
/// * *Layout* - presented by [Layout][rapaio.math.narray.Layout] describes how arrays logically organizes data. The only implementation is
/// [StrideLayout][rapaio.math.narray.layout.StrideLayout] which uses the concept of stride array to organize data
...
/// * *NArrayManager* - presented by the interface [NArrayManager][rapaio.math.narray.NArrayManager] handles creation of arrays with a specific computation strategy.
