 ...
 * of feature engineering. The transformations are collected into {@link Processing} collections
 ...
 * <li>one can call {@link #fitApply(Frame)} to call fit and apply subsequently; still the transformation
 * cannot be previously fitted</li>
 * <li>once the transform is fitted either by {@link #fit(Frame)} or {@link #fitApply(Frame)}, the transformation
