...
import rapaio.math.narrays.iterators.PointerIterator;
import rapaio.math.narrays.manager.AbstractStrideNArray;
import rapaio.math.narrays.matrix.CholeskyDecomposition;
import rapaio.math.narrays.matrix.EigenDecomposition;
import rapaio.math.narrays.matrix.LUDecomposition;
import rapaio.math.narrays.matrix.QRDecomposition;
import rapaio.math.narrays.matrix.SVDecomposition;
import rapaio.math.narrays.operator.Broadcast;
import rapaio.math.narrays.operator.Compare;
import rapaio.math.narrays.operator.NArrayBinaryOp;
import rapaio.math.narrays.operator.NArrayOp;
import rapaio.math.narrays.operator.NArrayReduceOp;
 ...
 * The implemented layout is a stride array layout provided by {@link rapaio.math.narrays.layout.StrideLayout}, but
...
public abstract sealed class NArray<N extends Number> implements Printable, Iterable<N> permits AbstractStrideNArray {
    ...
    public final NArray<N> sum(int axis) {
        return sum(axis, Order.defaultOrder());
    }

    public final NArray<N> sum(int axis, Order order) {
    ...
    public final NArray<N> nanSum(int axis) {
        return nanSum(axis, Order.defaultOrder());
    }

    public final NArray<N> nanSum(int axis, Order order) {
    ...
    public final NArray<N> prod(int axis) {
        return prod(axis, Order.defaultOrder());
    }

    public final NArray<N> prod(int axis, Order order) {
    ...
    public final NArray<N> nanProd(int axis) {
        return nanProd(axis, Order.defaultOrder());
    }

    public final NArray<N> nanProd(int axis, Order order) {
    ...
    public final NArray<N> amax(int axis) {
        return amax(axis, Order.defaultOrder());
    }

    public final NArray<N> amax(int axis, Order order) {
    ...
    public final NArray<N> nanMax(int axis) {
        return nanMax(axis, Order.defaultOrder());
    }

    public final NArray<N> nanMax(int axis, Order order) {
    ...
    public final NArray<N> amin(int axis) {
        return amin(axis, Order.defaultOrder());
    }

    public final NArray<N> amin(int axis, Order order) {
    ...
    public final NArray<N> nanMin(int axis) {
        return nanMin(axis, Order.defaultOrder());
    }

    public final NArray<N> nanMin(int axis, Order order) {
    ...
    public final NArray<N> corr(Order askOrder) {
        ...
        NArray<N> std = stdc(0, 0);
        NArray<N> scaled = sub(mean(0));
    ...
    public final NArray<N> mean(int axis) {
        return mean(axis, Order.defaultOrder());
    }

    public final NArray<N> mean(int axis, Order order) {
    ...
    public final NArray<N> std(int axis) {
        return std(axis, Order.defaultOrder());
    }

    public final NArray<N> std(int axis, Order order) {
    ...
    public final NArray<N> stdc(int axis, int ddof) {
        return stdc(axis, ddof, Order.defaultOrder());
    }

    public final NArray<N> stdc(int axis, int ddof, Order order) {
    ...
    public final NArray<N> var(int axis) {
        return var(axis, Order.defaultOrder());
    }

    public final NArray<N> var(int axis, Order order) {
        return varc(axis, 0, order);
    }

    public abstract N varc(int ddof);

    public final NArray<N> varc(int axis, int ddof) {
        return varc(axis, ddof, Order.defaultOrder());
    }

    public final NArray<N> varc(int axis, int ddof, Order order) {
        return alongAxisOperation(order, axis, t -> t.varc(ddof));
    }

    public final NArray<N> softmax(int axis) {
        return softmax(axis, Order.defaultOrder());
    }

    public final NArray<N> softmax(int axis, Order askOrder) {
        return copy(askOrder).softmax_(axis);
    }

    public abstract NArray<N> softmax_(int axis);


    public final NArray<N> logsoftmax(int axis) {
        return logsoftmax(axis, Order.defaultOrder());
    }

    public final NArray<N> logsoftmax(int axis, Order askOrder) {
        return copy(askOrder).logsoftmax_(axis);
    }

    public abstract NArray<N> logsoftmax_(int axis);
