...
public class AcfTest {
    ...
    private NumericVar corr2;
    private NumericVar corr3;
    private NumericVar cov2;
    private NumericVar cov3;
    ...
    public void setUp() {
        ...
        ts3 = NumericVar.wrap(
                ...
                -1.4497517922535001, -0.1403198814124193, 1.1962603720850546, -1.1999372448315526, -0.6278085018229833).withName("ts3");
        corr2 = NumericVar.wrap(
    ...
    public void basicTest() {
        ...
        for (int i = 0; i < acf2.correlation().rowCount(); i++) {
            assertEquals(corr2.value(i), acf2.correlation().value(i), TOL);
        }
        for (int i = 0; i < acf2.correlation().rowCount(); i++) {
            assertEquals(cov2.value(i), acf2.covariance().value(i), TOL);
        }
