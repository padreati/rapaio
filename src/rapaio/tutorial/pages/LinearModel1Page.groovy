...
import static rapaio.data.MathNumeric.mean
import static rapaio.data.MathNumeric.sd
import static rapaio.data.MathNumeric.var
 ...
 */
class LinearModel1Page implements TutorialPage {
    ...
    void render() throws IOException, URISyntaxException {
        ...
        p("""\
This tutorial aims to present how one can do by hand
...
linear regression models. """);
        ...
        p("""\
We will use the well-known data set Father-Son Heights. This
...
of the fathers and their full-grown sons, in England, circa 1900. """);
        ...
        p("""\
This data set is used to study the relation between the fathers
