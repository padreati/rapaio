...
public interface DVector extends Serializable, Printable, Iterable<Double> {
     ...
     *
     * @param size         size of the vector
     * @param d distribution which generates the values
     * @return dense vector with random values
     */
    static DVectorDense random(Random random, int size, Distribution d) {
        return DVectorDense.random(random, size, d);
    }
