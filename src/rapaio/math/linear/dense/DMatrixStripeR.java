...
public class DMatrixStripeR extends DMatrixStripe {
    ...
    @Override
    public rapaio.math.linear.dense.DMatrixStripeR copy() {
        rapaio.math.linear.dense.DMatrixStripeR copy = new rapaio.math.linear.dense.DMatrixStripeR(rowCount, colCount);
        for (int i = 0; i < rowCount; i++) {
