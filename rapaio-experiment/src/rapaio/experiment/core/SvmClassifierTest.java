...
public class SvmClassifierTest {
    ...
    public static void main(String[] args) {
        ...
        Plot plot1 = Plotter.plot();
        VectorDataGrid mg1 = computMesh(svm1, x1, x2);
        mg1.plot(plot1, 0, 1, 20);
        plot1.points(iris.rvar(0), iris.rvar(1), pch.circleFull(), GOptions.fill(iris.rvar(2)));
        grid.add(plot1);

        Plot plot2 = Plotter.plot();
        VectorDataGrid mg2 = computMesh(svm2, x1, x2);
        mg2.plot(plot2, Double.NaN, Double.NaN, 20);
        plot2.points(iris.rvar(0), iris.rvar(1), pch.circleFull(), GOptions.fill(iris.rvar(2)));
        grid.add(plot2);
