 ...
 */
public class VarToDoubleTransform extends AbstractVarTransform {
     ...
     */
    public static VarToDoubleTransform byDefault() {
        return new VarToDoubleTransform(new DefaultByType());
    }
     ...
     * @return new instance of double variable with transformed values
     */
    public static VarToDoubleTransform fromSpot(Function<VSpot, Double> fun) {
        return new VarToDoubleTransform(new TransformSpot(fun));
    }
     ...
     * @return new instance of double variable with transformed values
     */
    public static VarToDoubleTransform fromDouble(Double2DoubleFunction fun) {
        return new VarToDoubleTransform(new TransformDouble(fun));
    }
     ...
     * @return new instance of double variable with transformed values
     */
    public static VarToDoubleTransform fromInt(Int2DoubleFunction fun) {
        return new VarToDoubleTransform(new TransformInt(fun));
    }
     ...
     * @return new instance of double variable with transformed values
     */
    public static VarToDoubleTransform fromLabel(Function<String, Double> fun) {
        return new VarToDoubleTransform(new TransformLabel(fun));
    }
    ...
    private VarToDoubleTransform(Function<Var, Var> fun) {
        this.fun = fun;
    }

    @Override
    public VarTransform newInstance() {
        return new VarToDoubleTransform(fun);
    }
