...
public class VFToTest {
    ...
    public void testToNumeric() {
        Var num1 = NumericVar.wrap(1.0, 2.0, 1.2, Double.NaN, 3.0, Double.NaN, 3.2);
        Var nom1 = NominalVar.copy("1", "2", "1.2", "?", "3", "?", "3.2");
        Var nom2 = NominalVar.copy("1", "2", "1.2", "mimi", "3", "lulu", "3.2");
        Var idx1 = IndexVar.copy(1, 2, 3, Integer.MIN_VALUE, 3, Integer.MIN_VALUE, 4);
        Var bin1 = BinaryVar.copy(1, 0, 1, -1, 1, -1, 0);

        // by default transformer

        Assert.assertTrue(NumericVar.wrap(1, 2, 1.2, Double.NaN, 3, Double.NaN, 3.2)
        ...
        Assert.assertTrue(NumericVar.wrap(1, 2, 3, Double.NaN, 3, Double.NaN, 4)
                .deepEquals(idx1.fitApply(VFToNumeric.byDefault())));

        Assert.assertTrue(NumericVar.wrap(1, 0, 1, Double.NaN, 1, Double.NaN, 0)
                .deepEquals(bin1.fitApply(VFToNumeric.byDefault())));

        // by spot transformer

        Assert.assertTrue(NumericVar.wrap(1, 1, 1, 0, 1, 0, 1)
    ...
    public void testToIndex() {
        Var num1 = NumericVar.wrap(1.0, 2.0, 1.2, Double.NaN, 3.0, Double.NaN, 3.2);
        Var nom1 = NominalVar.copy("1", "2", "1.2", "?", "3", "?", "4");
        Var nom2 = NominalVar.copy("1", "2", "1.2", "mimi", "3", "lulu", "3.2");
        Var idx1 = IndexVar.copy(1, 2, 3, Integer.MIN_VALUE, 3, Integer.MIN_VALUE, 4);
        Var bin1 = BinaryVar.copy(1, 0, 1, -1, 1, -1, 0);
        ...
        Assert.assertTrue(IndexVar.wrap(1, 2, 1, Integer.MIN_VALUE, 3, Integer.MIN_VALUE, 3)
                .deepEquals(num1.fitApply(VFToIndex.byDefault())));

        Assert.assertTrue(IndexVar.wrap(1, 2, Integer.MIN_VALUE, Integer.MIN_VALUE, 3, Integer.MIN_VALUE, 4)
                .deepEquals(nom1.fitApply(VFToIndex.byDefault())));

        Assert.assertTrue(IndexVar.wrap(1, 2, Integer.MIN_VALUE, Integer.MIN_VALUE, 3, Integer.MIN_VALUE, Integer.MIN_VALUE)
                .deepEquals(nom2.fitApply(VFToIndex.byDefault())));

        Assert.assertTrue(IndexVar.wrap(1, 2, 3, Integer.MIN_VALUE, 3, Integer.MIN_VALUE, 4)
                .deepEquals(idx1.fitApply(VFToIndex.byDefault())));

        Assert.assertTrue(IndexVar.wrap(1, 0, 1, Integer.MIN_VALUE, 1, Integer.MIN_VALUE, 0)
                .deepEquals(bin1.fitApply(VFToIndex.byDefault())));

        // by spot transformer

        Assert.assertTrue(IndexVar.wrap(1, 1, 1, 0, 1, 0, 1)
