...
public class FillMissing extends AbstractTransform {
    ...
    public static FillMissing onLabel(String fill, VarRange varRange) {
        return new FillMissing(varRange, Type.STRING, null, 0, fill);
    }
    ...
    private final Integer intFill;
    private final String stringFill;

    private FillMissing(VarRange varRange, Type type, Double doubleFill, Integer intFill, String stringFill) {
        super(varRange);
        this.type = type;
