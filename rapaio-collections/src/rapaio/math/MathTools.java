...
public class MathTools {
    ...
    public static double erf(double x) {
        return 2 * normalCdf(x * SQRT_2, 0, 1) - 1;
    }
    ...
    public static double inverf(double x) {
        return normalQuantile(x / 2 + 0.5, 0, 1) / SQRT_2;
    }
    ...
    public static double erfc(double x) {
        return 2 * normalCdf(-x * SQRT_2, 0, 1);
    }
    ...
    public static double inverfc(double x) {
        return normalQuantile(x / 2, 0, 1) / -SQRT_2;
    }
    ...
    public static double normalQuantile(double p, double mu, double std) {
        if (p < 0 || p > 1) {
        ...
        double e = normalCdf(result, 0, 1) - p;
