...
public class AcfTest {
    ...
    public void setUp() {
        ...
        ts1 = SolidVarDouble.fill(20, 1).withName("ts1");
        ts2 = SolidVarDouble.seq(1, 20).withName("ts2");
        ts3 = SolidVarDouble.wrap(
