...
package rapaio.math.narrays.operator;

import rapaio.math.narrays.DType;
import rapaio.math.narrays.operator.impl.BinaryOpAdd;
import rapaio.math.narrays.operator.impl.BinaryOpDiv;
import rapaio.math.narrays.operator.impl.BinaryOpMax;
import rapaio.math.narrays.operator.impl.BinaryOpMin;
import rapaio.math.narrays.operator.impl.BinaryOpMul;
import rapaio.math.narrays.operator.impl.BinaryOpSub;
import rapaio.math.narrays.operator.impl.ReduceOpAdd;
import rapaio.math.narrays.operator.impl.ReduceOpMax;
import rapaio.math.narrays.operator.impl.ReduceOpMin;
import rapaio.math.narrays.operator.impl.ReduceOpMul;
import rapaio.math.narrays.operator.impl.UnaryOpAbs;
import rapaio.math.narrays.operator.impl.UnaryOpAcos;
import rapaio.math.narrays.operator.impl.UnaryOpAsin;
import rapaio.math.narrays.operator.impl.UnaryOpAtan;
import rapaio.math.narrays.operator.impl.UnaryOpCeil;
import rapaio.math.narrays.operator.impl.UnaryOpClamp;
import rapaio.math.narrays.operator.impl.UnaryOpCompareMask;
import rapaio.math.narrays.operator.impl.UnaryOpCos;
import rapaio.math.narrays.operator.impl.UnaryOpCosh;
import rapaio.math.narrays.operator.impl.UnaryOpExp;
import rapaio.math.narrays.operator.impl.UnaryOpExpm1;
import rapaio.math.narrays.operator.impl.UnaryOpFill;
import rapaio.math.narrays.operator.impl.UnaryOpFillNan;
import rapaio.math.narrays.operator.impl.UnaryOpFloor;
import rapaio.math.narrays.operator.impl.UnaryOpLog;
import rapaio.math.narrays.operator.impl.UnaryOpLog1p;
import rapaio.math.narrays.operator.impl.UnaryOpNanToNum;
import rapaio.math.narrays.operator.impl.UnaryOpNeg;
import rapaio.math.narrays.operator.impl.UnaryOpPow;
import rapaio.math.narrays.operator.impl.UnaryOpRint;
import rapaio.math.narrays.operator.impl.UnaryOpSigmoid;
import rapaio.math.narrays.operator.impl.UnaryOpSin;
import rapaio.math.narrays.operator.impl.UnaryOpSinh;
import rapaio.math.narrays.operator.impl.UnaryOpSqr;
import rapaio.math.narrays.operator.impl.UnaryOpSqrt;
import rapaio.math.narrays.operator.impl.UnaryOpTan;
import rapaio.math.narrays.operator.impl.UnaryOpTanh;
