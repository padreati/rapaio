...
public final class Ints {
     ...
     * @return array with sequence values
     */
    public static int[] seq(final int start, final int end) {
     ...
     */
    public static int[] from(int len, Int2IntFunction fun) {
     ...
     * @return transformed values array
     */
    public static int[] from(int[] source, int start, int end, Int2IntFunction fun) {
        int[] data = new int[end - start];
    ...
    public static int[] copyOf(int[] array, int start, int len) {
        int[] data = new int[len];
