...
public class RandomValueRegression extends AbstractRegression implements Printable {
    ...
    public RandomValueRegression newInstance() {
        return newInstanceDecoration(new RandomValueRegression(distribution));
    }
    ...
    @Override
    public RandomValueRegression fit(Frame df, String... targetVars) {
        return (RandomValueRegression) super.fit(df, targetVars);
    }

    @Override
    public RandomValueRegression fit(Frame df, Var weights, String... targetVarNames) {
        return (RandomValueRegression) super.fit(df, weights, targetVarNames);
    }
